"""
The scripts is providing functions for parsing metadata from NCBI
like
bioproject information in xml format
biosample information in xml format
assembly information in xml format
"""
...
def parse_bioproject_xml(xml_text):
    ...
    for each_record in split_out:
        ...
        bioproject2info[bioproject_id]['number of biosamples'] = len(list_biosample)
